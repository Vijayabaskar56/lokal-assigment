  ...
  const palettes = {
        ...
        "light": ['hsla(43, 100%, 55%, 1)','hsla(0, 0%, 100%, 0)','hsla(0, 0%, 100%, 0.25)','hsla(0, 0%, 100%, 0.5)','hsla(0, 0%, 100%, 0.75)','hsla(0, 0%, 100%, 1)','hsla(0, 0%, 94%, 1)','hsla(0, 0%, 89%, 1)','hsla(0, 0%, 83%, 1)','hsla(0, 0%, 78%, 1)','hsla(0, 0%, 72%, 1)','hsla(0, 0%, 67%, 1)','hsla(0, 0%, 61%, 1)','hsla(0, 0%, 56%, 1)','hsla(0, 0%, 50%, 1)','hsla(0, 15%, 15%, 1)','hsla(0, 15%, 10%, 1)','hsla(0, 14%, 10%, 0.75)','hsla(0, 14%, 10%, 0.5)','hsla(0, 14%, 10%, 0.25)','hsla(0, 14%, 10%, 0)','hsla(43, 100%, 63%, 1)']
      ,
        "dark": ['hsla(43, 100%, 57%, 1)','hsla(0, 0%, 10%, 0)','hsla(0, 0%, 10%, 0.25)','hsla(0, 0%, 10%, 0.5)','hsla(0, 0%, 10%, 0.75)','hsla(0, 0%, 10%, 1)','hsla(0, 0%, 14%, 1)','hsla(0, 0%, 19%, 1)','hsla(0, 0%, 23%, 1)','hsla(0, 0%, 28%, 1)','hsla(0, 0%, 32%, 1)','hsla(0, 0%, 37%, 1)','hsla(0, 0%, 41%, 1)','hsla(0, 0%, 46%, 1)','hsla(0, 0%, 50%, 1)','hsla(0, 15%, 93%, 1)','hsla(0, 15%, 95%, 1)','hsla(0, 15%, 95%, 0.75)','hsla(0, 15%, 95%, 0.5)','hsla(0, 15%, 95%, 0.25)','hsla(0, 15%, 95%, 0)','hsla(43, 100%, 43%, 1)']
      ,
        "light_accent": ['hsla(0, 0%, 83%, 1)','hsla(43, 100%, 50%, 0)','hsla(43, 100%, 50%, 0.25)','hsla(43, 100%, 50%, 0.5)','hsla(43, 100%, 50%, 0.75)','hsla(43, 100%, 50%, 1)','hsla(43, 100%, 52%, 1)','hsla(43, 100%, 53%, 1)','hsla(43, 100%, 55%, 1)','hsla(43, 100%, 57%, 1)','hsla(43, 100%, 58%, 1)','hsla(43, 100%, 60%, 1)','hsla(43, 100%, 62%, 1)','hsla(43, 100%, 63%, 1)','hsla(43, 100%, 65%, 1)','hsla(250, 50%, 95%, 1)','hsla(250, 50%, 95%, 1)','hsla(249, 52%, 95%, 0.75)','hsla(249, 52%, 95%, 0.5)','hsla(249, 52%, 95%, 0.25)','hsla(249, 52%, 95%, 0)','hsla(0, 0%, 56%, 1)']
      ,
        "dark_accent": ['hsla(0, 0%, 46%, 1)','hsla(43, 100%, 35%, 0)','hsla(43, 100%, 35%, 0.25)','hsla(43, 100%, 35%, 0.5)','hsla(43, 100%, 35%, 0.75)','hsla(43, 100%, 35%, 1)','hsla(43, 100%, 38%, 1)','hsla(43, 100%, 41%, 1)','hsla(43, 100%, 43%, 1)','hsla(43, 100%, 46%, 1)','hsla(43, 100%, 49%, 1)','hsla(43, 100%, 52%, 1)','hsla(43, 100%, 54%, 1)','hsla(43, 100%, 57%, 1)','hsla(43, 100%, 60%, 1)','hsla(250, 50%, 90%, 1)','hsla(250, 50%, 95%, 1)','hsla(249, 52%, 95%, 0.75)','hsla(249, 52%, 95%, 0.5)','hsla(249, 52%, 95%, 0.25)','hsla(249, 52%, 95%, 0)','hsla(0, 0%, 23%, 1)']
